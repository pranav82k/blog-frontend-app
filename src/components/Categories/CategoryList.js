...
const CategoryList = () => {
  ...
  return (
    <>
        ...
        <h2 className='text-center text-3xl text-red-500'> {serverErr} {appErr}</h2>
        ) : categoryList?.length <= 0 ? (
        <h2 className='text-center text-3xl text-green-800'>No Category Found</h2>
        ) : (
