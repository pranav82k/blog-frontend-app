            ...
            <div className="container mx-auto px-4">
              ...
              <div className="flex flex-wrap -mx-3">
                  ...
                  <div className="py-4 px-6 bg-gray-600 shadow rounded">
                    ...
                    <ul>
                      ...
                      <LoadingComponent />
                        ...
                        <h1 className="text-yellow-400 text-center text-lg">{catServerErr} {catAppErr}</h1>
                      ) : categoryList?.length <= 0 ? <h1 className="text-yellow-400 text-lg text-center">No Category Found</h1> : categoryList?.map(category => (
                        <li key={category?._id}>
                ...
                <div className="w-full lg:w-3/4 px-3">
                  ...
                  { appErr || serverErr ? (
                    <h1 className="text-yellow-400 text-center text-lg">{serverErr} {appErr}</h1>
                  ) : postLists?.length <= 0 ? (
