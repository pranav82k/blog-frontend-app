...
import { updateUserProfileAction, fetchUserDetailsAction } from "../../../redux/slices/users/usersSlices";
...
const UpdateProfileForm = () => {
  ...
  const { userAuth, profile, profileUpdateRedirection, loading, appErr, serverErr } = user;
  ...
  if(profileUpdateRedirection) return <Redirect to={`/profile/${profile._id}`} />;
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {/* Err */}
        { appErr || serverErr ? <h2 className="text-red-300 text-center">{serverErr} {appErr}</h2> : null }
      </div>
